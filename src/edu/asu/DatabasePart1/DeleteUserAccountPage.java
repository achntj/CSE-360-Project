 ...
 * 
 * <p>
 * Description: Interactive JavaFX page that allows admin users to remove
...
public class DeleteUserAccountPage {
	 ...
	 * presented for the DeleteUserAccountPage. It sets up the alignment and text
	 * fields used as well as manages the interactions with the page and handles
	 * errors that occur.
	 * 
	...
	public DeleteUserAccountPage(Stage primaryStage, DatabaseHelper databaseHelper, String email) {
		...
		deleteUserButton.setOnAction(event -> {
			...
			Alert confirmation = new Alert(Alert.AlertType.CONFIRMATION, "Are you sure you want to delete this user?",
			...
			if (confirmation.getResult() == ButtonType.YES) {
				try {
					...
					e.printStackTrace();
					showAlert("Database Error", "An error occurred while deleting the user account.",
