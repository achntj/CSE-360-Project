 ...
 * 
 * <p>
 * Description: Page of JavaFX implemented application that allows users to
 * complete the set up of their accounts and adds the information gathered to
 * the database.
 * </p>
 * 
 * <p>
	...
	public CompleteAccountSetupPage(Stage primaryStage, DatabaseHelper databaseHelper, String email) {
		...
		completeSetupButton.setOnAction(event -> {
			...
			try {
				...
				databaseHelper.updateUserAccount(email, firstName, middleName, lastName, preferredName, javaLevel,
						javaFXLevel, githubLevel);
