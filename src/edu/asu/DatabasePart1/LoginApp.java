 ...
 * 
 * <p>
 * Description: The main class for the login and registration system. It manages
 * the launch of the application and determines whether the first-time admin
 * setup or regular login page should be displayed, depending on the state of
 * the database.
 * </p>
 * 
 * <p>
...
public class LoginApp extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			...
			// If an error occurs while connecting, print the stack trace and exit the
			// application
			e.printStackTrace();
			System.exit(1);
		}
	...
	/************
	 * The stop method is called when the application is closed and ensures that the
