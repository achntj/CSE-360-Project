...
public class RegisterStudentPage {
     ...
     */
    public RegisterStudentPage(Stage primaryStage, DatabaseHelper databaseHelper) {
        ...
        registerGrid.add(emailLabel, 0, 0);
        registerGrid.add(emailField, 2, 0);
        registerGrid.add(usernameLabel, 0, 1);
        registerGrid.add(usernameField, 2, 1);
        registerGrid.add(passwordLabel, 0, 2);
        registerGrid.add(passwordField, 2, 2);
        registerGrid.add(confirmPasswordLabel, 0, 3);
        registerGrid.add(confirmPasswordField, 2, 3);
        registerGrid.add(createAccountButton, 2, 4);
        registerGrid.add(backToLoginButton, 0, 4);

        // Adds functionality for the 'Create Account' button
        createAccountButton.setOnAction(event -> handleAccountCreation(emailField, usernameField,
     ...
     */
    private void handleAccountCreation( TextField emailField, TextField usernameField,
        ...
        try {
            databaseHelper.ensureConnection();
            boolean registrationSuccessful = databaseHelper.registerStudentWithEmail(email, username, password);
            if (registrationSuccessful) {
                ...
                showAlert("Error", "Incorrect Email. Please check and try again.", Alert.AlertType.ERROR);
            }
