 ...
 * 
 * <p>
 * Description: This class provides the user interface for creating a new
 * account using an invitation code. It validates user input, checks password
 * strength, and handles user registration with the database.
 * </p>
 * 
 * <p>
	...
	public RegisterPage(Stage primaryStage, DatabaseHelper databaseHelper) {
		...
		createAccountButton.setOnAction(event -> {
			...
			try {
				...
				boolean registrationSuccessful = databaseHelper.registerWithInvitationCode(invitationCode, username,
						password);
		...
		// Adds functionality for the 'Back to Login' button to redirect to the login
		// page
